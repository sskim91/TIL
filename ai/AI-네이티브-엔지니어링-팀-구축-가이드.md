...
METR이 측정하는 **"50% time horizon"** 은 자주 오해되는 지표다. AI가 실제로 그 시간 동안 자율적으로 일한다는 뜻이 *아니라*, **"인간 전문가가 그 정도 걸리는 난이도의 과제를 AI가 50% 신뢰도로 완료할 수 있는 난이도 상한"** 을 뜻한다 (즉 *과제 난이도 지표*이지 *세션 길이*가 아니다).

| 시기 | 모델 | 50% time horizon |
|------|------|------------------|
| 2020년 | GPT-2 | ~0분 (웹 사실 찾기 수준) |
| 2022년 | GPT-3.5 | ~30초 (작은 코드 제안) |
| 2025년 2월 | Claude 3.7 Sonnet | ~1시간 |
| 2025년 8월 | GPT-5 | **2시간 17분** |
| 2025년 11월 | GPT-5.1-Codex-Max | **약 2시간 42분** (METR 50% time horizon, 2025-11-19 평가 기준) |

**time horizon이 약 7개월마다 2배로 증가** → 인간이 더 오래 걸리는 난이도의 과제까지 AI 지원 범위에 들어옴
