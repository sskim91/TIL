...
| 속도 | 빠름 | 상대적으로 느림 |
| SSL 종료 | ⚠️ 전통적 L4는 불가, AWS NLB는 TLS Listener로 가능(2019.01~) | ✅ 기본 기능 |
| 콘텐츠 라우팅 | ❌ | ✅ |
...
| **SSL** | 전통적으로 패스스루 (NLB는 TLS Listener로 종료 가능) | 복호화 후 평문 전달 |
...
| **리소스 사용** | 낮음 | 높음 |
| **SSL 종료** | 전통적 L4: ❌ 패스스루 / AWS NLB TLS Listener: ✅ (2019.01~) | ✅ 기본 기능 |
| **콘텐츠 라우팅** | ❌ | ✅ |
