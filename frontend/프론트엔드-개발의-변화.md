...
| **React Router v7** (구 Remix) | React | 웹 표준 중심, 중첩 라우팅 — Remix는 [2024년 5월 React Router v7로 통합 발표](https://remix.run/blog/merging-remix-and-react-router) 후 2024년 12월 v7 정식 출시. 현재 신규 프로젝트는 React Router v7을 사용한다 |
