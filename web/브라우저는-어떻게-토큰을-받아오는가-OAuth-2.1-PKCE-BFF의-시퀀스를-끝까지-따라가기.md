...
[2-1편](토큰을-어디에-둘-것인가-Cookie-Authorization-Header-Storage-5종-완전-비교.md)이 "받아온 토큰을 어디에 둘 것인가"를 닫았다면, 이 글은 그 앞에 놓인 더 본질적인 질문을 닫는다. **그 토큰은 도대체 어떻게, 어떤 시퀀스를 거쳐 브라우저까지 도착하는가.**
